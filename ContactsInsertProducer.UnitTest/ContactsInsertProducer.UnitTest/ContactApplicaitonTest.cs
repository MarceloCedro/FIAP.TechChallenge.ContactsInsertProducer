...
namespace ContactsInsertProducer.UnitTest
{
    public class ContactApplicaitonTest
    {
        ...
        public async Task ValidateFakeTokenAsync()
        {
            ...
            var retorno = await contactApplication.AddContactAsync(null);
        ...
        public async Task ValidateContactSendingContactExceptionAsync()
        {
            ...
            Assert.False(retorno.Success);
            Assert.Equal("Ocorreu um problema ao tentar inserir o registro.", retorno.Message);
        }
        ...
        public async Task ValidateContactSendingContactAsync()
        {
            ...
            Assert.Equal("Contato inserido na FILA com sucesso.", retorno.Message);
        }
